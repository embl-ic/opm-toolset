 ...
 * <p>	1b, {@link #party_mode(String)}: the scriptable switch for the party theme. It is here
 * <br>	rather than on {@link Party} because this is the class a user already reaches for when
 * <br>	they want to see or change what the toolset is doing, and because the environment report
 * <br>	is the theme's other switch.
...
public class Debug implements PlugIn {
	...
	public void run(String arg) {
		// first command of the session turns the party theme off for it; see Party
